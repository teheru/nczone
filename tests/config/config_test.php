    ...
    public function module_data_provider(): array
    {
        return [
            ...
            [config::ACL_CONFIG_KEYS, [
                ...
                ['config.add', [config::free_points, config::default(config::free_points)]],
                ['config.add', [config::free_points_regular, config::default(config::free_points_regular)]],
                ['config.add', [config::free_points_unrated, config::default(config::free_points_unrated)]],
                ['config.add', [config::free_points_difference, config::default(config::free_points_difference)]],

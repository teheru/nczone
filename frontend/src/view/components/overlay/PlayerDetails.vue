<template>
  <nczone-overlay class="zone-player-details" :title="'NCZONE_PLAYER_DETAILS_TITLE'" @close="closeOverlay">
...
export default {
  ...
  computed: {
    player () {
      return this.overlayPayload.player
    },
    details () {
      return this.overlayPayload.details
    },
    dreamteams () {
      return this.overlayPayload.dreamteams
    },
    nightmareteams () {
      return this.overlayPayload.nightmareteams
    },
    ratingData () {
      return this.overlayPayload.ratingData
    },
    ...mapGetters([
      'overlayPayload'
    ])

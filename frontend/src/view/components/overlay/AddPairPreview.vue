<template>
  <nczone-overlay class="zone-add-pair-preview" :title="'NCZONE_DRAW_PREVIEW'" @close="cancel">
    <template slot="content">
      <div v-if="canAddPairMod || canAddPairUser">
    ...
    <template slot="actions">
      <button v-if="canAddPairMod || canAddPairUser" class="zone-button" v-t="'NCZONE_CANCEL'" @click="cancel"></button>
      <button v-if="canAddPairMod || canAddPairUser" class="zone-button" v-t="'NCZONE_OK'" @click="confirm"></button>
      <button v-if="!canAddPairMod && !canAddPairUser" class="zone-button" v-t="'NCZONE_OK'" @click="cancel"></button>
    </template>
  </nczone-overlay>
</template>
<script>
